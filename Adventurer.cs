...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Adventurer(string name, Robe robe, Hat hat, int SucessfulChallenges)
        {
            Name = name;
            Awesomeness = 50;
            ColorfulRobe = robe;
            Hat = hat;
            SucessfulChallenges = 0;
        ...
        public string GetDescription()
        {
            ...
            return $"{Name} is wearing a  {ColorfulRobe.Length} inch long {string.Join(", ", ColorfulRobe.Colors)} robe. With a {Hat.ShininessDescription} hat to match!";
        }
